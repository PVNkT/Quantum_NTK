...
def main(cfg = OmegaConf.load("Quantum_NTK/config.yaml")):
    ...
    model_params = OmegaConf.load(f"Quantum_NTK/{data_type}.yaml")
    ...
    data_class = data(cfg)
    train_data, test_data = data_class.processed_train, data_class.processed_test 
