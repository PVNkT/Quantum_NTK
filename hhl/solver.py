import numpy as np
from hhl.circuit import circuit
from hhl.normalize import calculate_vector
from hhl.value_setter import value_setter
...
def HHL_my(A, b, wrap = True, measurement = None): #Ax =b linear system solver.
    """
    ...
    """
    print("Solving kernel norm as HHL algorithm")
    hermition = True
